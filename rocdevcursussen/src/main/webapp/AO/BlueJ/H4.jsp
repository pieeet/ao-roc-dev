...
<div class="container">
	...
	<div class="col-md-9">
		...
		<h3>Associatie</h3>
		<p>In dit hoofdstuk leer je hoe je in een klasse objecten van een
			andere klasse kunt gebruiken. Een klasse kan een attribuut hebben dat
			een object is van een andere klasse. Er is dan sprake van een
			associatie. In BlueJ wordt dit mooi ge&iuml;llustreerd doordat er een
			stippellijn tussen de klassen wordt getoond.</p>
		<img class="imgfullwidth" src="/AO/BlueJ/images/assoociatiev2.jpg">
		<h3>Referenties</h3>
		<p>
			Om een team te kunnen maken moeten er spelers zijn. De klasse team
			heeft daarom twee attributen van het type Speler. Omdat de attributen
			<em>verwijzen</em> naar objecten die tot een andere klasse behoren,
			noemen we ze referenties of referentieobjecten. In een klasse kunnen
			objecten van een andere klasse worden gecre&euml;erd met het keyword
			<em>new</em>. Deze roept de constructor van de klasse Speler aan.
		</p>
