...
public class Team {
    ...
    public Team() {
		...
		<code>Import...</code>). Als het goed is zie je dat er in het venster van BlueJ een stippellijn loopt tussen de
		...
		lid1 en lid2 met daarachter een kromme pijl. Dat betekent dat dit referenties zijn die naar een object wijzen.
...
public void print() {
    ...
    System.out.println(&quot;-----------------------------&quot;);
		...
		Leerling-objecten gemaakt worden, er is geen mogelijkheid een andere samenstelling van het team te maken.</p>
		...
		mogelijkheid hebt telkens bij het maken van een Team-object andere leerlingen aan het team toe te voegen.</p>
...
String tekst = &quot;abc&quot; + &quot;def&quot;
		...
		en het type String heel verschillend zijn, kun je met het plus-teken ook een getal achter een string plakken.</p>

<pre class="code">
String tekst = &quot;Leeftijd is &quot; + 17;
</pre>
		<p>De tekens (cijfers) worden automatisch naar een String geconverteerd. Als je alleen een getal in de vorm
			van een String wilt tonen kun je een lege string gebruiken.</p>
<pre class="code">
String tekst = &quot;&quot; + 17;
</pre>
...
public void print() {
    ...
    System.out.println("-----------------------------");
		...
		<ul>
			...
			dat je die methode expliciet hebt aangeroepen op het object.</li>
		</ul>
