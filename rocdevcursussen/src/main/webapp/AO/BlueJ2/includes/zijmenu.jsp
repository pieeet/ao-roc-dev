...
<div class="col-md-3">
	...
	<div id="menu">
		...
		<h3>Web Links</h3>
		<ul>
			<li class="list-group-item"><a href="https://github.com/ROC-DEV/bluej-voorbeelden" target="_blank">
				Voorbeelden</a></li>
			<li class="list-group-item"><a
					href="/AO/BlueJ/CDRom/index.html">Antwoorden op de vragen</a> </li>
			<li class="list-group-item"><a href="http://bluej.org/" target="_blank">BlueJ</a></li>
			<li class="list-group-item"><a href="http://docs.oracle.com/javase/7/docs/api/"
