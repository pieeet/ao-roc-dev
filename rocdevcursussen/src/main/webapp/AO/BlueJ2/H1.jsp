...
<div class="container">
	...
	<div class="col-md-9">
		...
		<div class="bs-callout bs-callout-info">
			...
			<p>
				Op de CD ROM van het leerboek of <a
					href="/AO/BlueJ/CDRom/index.html">hier</a> kun je de antwoorden op
				de vragen in het boek vinden.
			</p>
		</div>
		...
		<p>
			In het eerste hoofdstuk ga je aan de slag met de <i>klasse</i> Lamp.
			Deze kun je vinden in de voorbeelden. Lamp is een klasse. Een klasse
			is een soort bouwtekening. Van een klasse kun je een concreet <em>object</em>
			maken door de <em>constructor</em> aan te roepen.
		</p>
...
Lamp lamp2 = new Lamp(200);
		...
		<p>
			Een constructor is een speciale <i>methode</i> waarmee je een
			concreet object van een klasse aan kunt maken. Een klasse kan
			meerdere constructors hebben. Lamp bijvoorbeeld heeft twee
			...
			komen. Bij deze constructor moet je de gewenste positie als <i>parameter</i>
			meegeven.
		</p>
...
lamp2.aan();
		...
		<p>De naam van een constructor is altijd hetzelfde als de naam van
			de klasse, inclusief hoofdletter.</p>

		<h3>Attributen</h3>
		<p>
			Een klasse heeft bepaalde eigenschappen - de <i>attributen</i>. De
			klasse Lamp bijvoorbeeld heeft drie attributen:
		<ul>
			<li>positie, uitgedrukt in int: een geheel getal;</li>
			<li>isZichtbaar, uitgedrukt in boolean: waar (true) of niet waar
				(false)</li>
			<li>isAan, ook uitgedrukt in boolean</li>
		</ul>
		<p>Attributen zijn - uitzonderingen daargelaten - private. Dit
			betekent dat ze niet direct aangeroepen kunnen worden. Om de toestand
			van attributen op te vragen worden methoden gebruikt.</p>
		...
		<p>
			Methoden die iets teruggeven als ze worden aangeroepen. Vaak is dit
			de toestand van een attribuut. De <i>terugkeerwaarde</i> van de
...
boolean b = lamp1.isAan();
		...
		<p>
			...
			toestand van een attribuut. De methoden aan() en uit() bijvoorbeeld
			veranderen de toestand van het attribuut isAan in respectievelijk
			true en false. Methoden zonder terugkeerwaarde krijgen als
			terugkeerwaarde <i> <a
				href="http://translate.google.nl/#en/nl/void">void</a>.
			</i>
		</p>
		<pre class="code">
...
lamp1.uit();
		...
		<p>Methoden kunnen, mits ze toegankelijk (public) zijn worden
			...
			het object te klikken (zie screenshot).</p>
		<img class="imgfullwidth" src="/AO/BlueJ/images/H1Lamp.jpg"
			alt="screenshot klasse lamp">
