...
&lt;/menu&gt;
			...
			<img src="<c:url value="/AO/android/H5/menu1.jpg"/>">
		</div>
		...
		<div class="opdrachten">
			...
			<img src="<c:url value="/AO/android/H5/ic_settings_new.png"/>"
   ...
   /&gt;
			...
			<img src="<c:url value="/AO/android/H5/menu2.jpg"/>">
   ...
   /&gt;
			...
			<img src="<c:url value="/AO/android/H5/menu3.jpg"/>">
   ...
   switch (item.getItemId() ) {
       ...
       default:
		...
		<div class="opdrachten">
			...
			<img src="<c:url value="/AO/android/H5/info_dialog.jpg"/>">
			<ol>
   ...
   switch (item.getItemId() ) {
       ...
       default:
		...
		<div class="opdrachten">
			...
			<img src="<c:url value="/AO/android/H5/settings1.jpg"/>"><img
				src="<c:url value="/AO/android/H5/settings2.jpg"/>">
...
if (afronding == AFROND_GEEN) {
    <span class="codeplus">afrondGeenRadioButton.setChecked(true);</span>
		...
		<div class="opdrachten">
			...
			<img src="<c:url value="/AO/android/H5/settings3.jpg"/>">
			<ol>
...
&lt;/PreferenceCategory&gt;
			...
			<img src="<c:url value="/AO/android/H5/settings4.jpg"/>" width=300>
...
&lt;/ListPreference&gt;
			...
			<p>Het kan voorkomen dat je een item juist wilt activeren als een
				...
				overruled.</p>
			<img src="<c:url value="/AO/android/H5/settings5.jpg"/>"><img
				src="<c:url value="/AO/android/H5/settings6.jpg"/>">
