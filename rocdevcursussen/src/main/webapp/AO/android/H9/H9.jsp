...
<div class="container">
	...
	<div class="col-md-9">
		...
		<div class="img_met_bijschrift">
			...
			<img src="<c:url value="/AO/android/H9/takenlijst_1.png"/>">
		</div>
		<div class="img_met_bijschrift">
			<p>Voeg toe / wijzig taak</p>
			<img src="<c:url value="/AO/android/H9/takenlijst_2.png"/>">
		</div>
		<div class="img_met_bijschrift">
			<p>Tab layout</p>
			<img src="<c:url value="/AO/android/H9/takenlijst_3.png"/>">
		</div>
		<p style="clear: both">De takenlijst werkt met twee verschillende lijsten: persoonlijk
		...
		<p>Onderstaande tekening toont een diagram voor de takenlijst
			database.</p>
		<img src="<c:url value="/AO/android/H9/erd.png"/>">
...
public class TakenlijstDB {
    ...
    <span class="comment">//database constanten om de tabellen te cre�ren of droppen</span>
