...
<div class="container">
	...
	<div class="col-md-9">
		<h2>Kaarten delen</h2>
		<h3>Voorbeeld</h3>
		<form action="<c:url value="/AO/inleiding-java/deel-kaarten?deel_kaart"/>" method="get">
...
private String[] kaarten = {&quot;twee&quot;, &quot;drie&quot;, &quot;vier&quot;, &quot;vijf&quot;, &quot;zes&quot;, &quot;zeven&quot;, 
		...
		<p>Maak een array &quot;deck&quot; waar alle kaarten in komen en 4
			arrays waar de kaarten van de vier spelers in komen.</p>
...
private String[] speler4 = new String[13];
		...
		<p>In de methode init() kun je het deck vullen met behulp van twee
			lussen. Hiervoor heb je een teller nodig die doortelt tot het deck
			gevuld is.</p>
...
for (int i = 0; i &lt; kleuren.length; i++) {
    ...
    for (int j = 0; j &lt; kaarten.length; j++) {
		...
		<p>Om de arrays van de 4 spelers te vullen kun je een hulpmethode
			maken die een willekeurige kaart uit het deck haalt. Een kaart mag
			natuurlijk maar &eacute;&eacute;n keer gedeeld worden. Dit is lastig
			want je kunt een array niet kleiner of groter maken nadat hij is
			aangemaakt. Om dit probleem op te lossen kun je een nieuwe array
			maken die gevuld wordt met alle kaarten uit het deck, behalve degene
			die net gedeeld is. Deze hulparray vervangt deck nadat hij is
			aangemaakt.</p>
...
private String deelKaart() {	
    ...
    return kaart;
		...
		<p>Nu kun je met behulp van de hulpmethode de kaarten verdelen in
			de methode init().</p>
...
for (int i = 0; i &lt; 13; i++ ) {
    ...
    speler4[i] = deelKaart();
		...
		<p>Tot slot moet je de kaarten nog op het scherm zetten met
			paint().</p>
		<pre class="code">
