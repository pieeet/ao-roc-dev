...
<div class="container">
	...
	<div class="col-md-9">
		...
		<h4>Praktijk</h4>
		<img src="<c:url value="/AO/InlJava/H12/images/tabellenTransp.png"/>">
		<h3>Inleiding</h3>
		<p>
...
public class Tabel extends Applet {
    ...
    public void paint(Graphics g) {
		...
		<img src="<c:url value="/AO/InlJava/H12/images/referentie.png"/>">
...
for(int teller = 0; teller &lt; salaris.length; teller ++) {
    kopie[teller] = salaris[teller];
		...
		<img src="<c:url value="/AO/InlJava/H12/images/kopie.png"/>">
