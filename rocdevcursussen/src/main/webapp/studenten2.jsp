...
<div class="container">
    ...
    <div class="col-md-9">
        ...
        <% if (user == null) { %>
        <p>Log in met een <a href="<%= userService.createLoginURL("http://ao.roc-dev.com/studenten") %>">roc-dev
            Account</a> om je
            ...
            <div class="bs-callout bs-callout-warning">
                ...
                <form action="/studenten" method="post">
                    <div class="formulier">
                        <div class="formulier_regel">
                            <label class="formulier_label">URL portfolio</label>
                            <input type="url" name="nieuwe_student_portfolio" class="formulier_input"
                                   value="<%=student.getWebpage() %>">
                        </div>
                        <div class="formulier_regel">
                            <input type="submit" class="formulier_input formulier_input_marge" name="wijzig_url_knop"
                                   value="wijzig portfolio">
                        </div>
                    </div>
                </form>
                <% if (request.getAttribute("boodschap") != null) { %>
