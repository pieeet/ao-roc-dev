...
<%
	      ...
	      <div class="col-md-10">
	        ...
	        <div class="bs-callout bs-callout-warning">
	        	...
	        	<% } else { %>
		        	<form action="/_admin" method="post">
						<table>
							<tr>
								<td><label>Voornaam</label></td><td><input type="text" name="wijzig_student_voornaam"size="20" value="<%= student.getVoornaam() %>"></td>
							</tr>
							<tr>
								<td><label>Tussenvoegsels</label></td><td><input type="text" name="wijzig_student_tussenvoegsels"size="12" value="<%= student.getTussenvoegsels() %>"></td>
							</tr>
							<tr>
								<td><label>Achternaam</label></td><td><input type="text" name="wijzig_student_achternaam"size="20" value="<%= student.getAchternaam() %>"></td>
							</tr>
							<tr>
								<td><label>Cohort</label></td>
								<td><input type="number" name="wijzig_student_cohort" value="<%= student.getCohort() %>">
							</tr>
							<tr>
								<td><label>URL portfolio</label></td><td><input type="text" name="wijzig_student_portfolio" value="<%= student.getWebpage() %>"></td>
							</tr>
							<tr>
								<td><label>Level</label></td><td><input type="number" name="wijzig_student_level" value="<%= student.getLevel() %>"></td>
							</tr>
							<tr>
								<td></td><td><input type="submit" name="wijzig_student_knop" value="wijzig"></td>
							</tr>
						</table>
	        ...
	        <div class="bs-callout bs-callout-info">
		        <table id="studentenoverzicht">
	        		<tr>
	        			<th>naam</th><th>cohort</th><th>level</th><th>email</th>
	        		</tr>
	...
	<p>Log in met een <a href="<%= userService.createLoginURL(request.getRequestURI()) %>">roc-dev moderator account</a> voor toegang tot de site</p>
