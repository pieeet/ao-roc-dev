...
<div class="col-md-3">
    ...
    <div id="menu">
        <h3>Cursussen</h3>
        <ul>
            <li><a href="<c:url value="/AO/inleiding-java/h1"/>">Inleiding Java</a></li>
            <li><a href="<c:url value="/AO/BlueJ/intro"/>">BlueJ</a></li>
        ...
        <h3>Studenten</h3>
        <ul>
            <li><a href="<c:url value="/studenten"/>">Portfolio&#39;s</a></li>
        </ul>
    </div>
</div>