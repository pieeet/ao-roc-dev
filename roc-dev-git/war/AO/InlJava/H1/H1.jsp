		...
		<div class="bs-callout bs-callout-warning">
			...
			<ul>
				<li>de benodigde software hebt ge&iuml;nstalleerd om Java
					programma&#39;s te ontwikkelen en uit te voeren</li>
				<li>een &quot;Integrated Development Environment&quot; (IDE)
					hebt ge&iuml;nstalleerd en een java project kunt maken</li>
				<li>een GitHub project kunt forken en clonen naar je computer</li>
				<li>wijzigingen in een repository kunt committen en
					synchroniseren naar GitHub of naar je lokale repository</li>
...
c = a + b; 
			...
			<img class="gewoon_plaatje"
				src="/AO/InlJava/H1/images/vacature_test_specialist.png">
			...
			<img src="/AO/InlJava/H1/images/fouten.png" class="gewoon_plaatje"
				alt="programmeerfouten" id="programmeerfouten">

			<div class="opdrachten">
				<h2>Opdracht 1.1 Installeer Java JDK</h2>
				<p>
					De JDK is de java development kit. Om een java programma op een
					computer te compileren en uit te voeren moet de nodige software
					ge&iuml;nstalleerd zijn. In andere cursussen gaan we met Google App
					Engine werken. App Engine werkt met <a
						href="http://www.oracle.com/technetwork/java/javase/downloads/jdk7-downloads-1880260.html"
						target="_blank">java versie 7</a>, dus het is wel zo handig om
					deze meteen te installeren. Installeer een voor jouw computer
				...
				<ul>
					...
					<li>Als je later een andere jdk wilt installeren, dan kun je
						volstaan met het aanpassen van de JAVA_HOME variabele.</li>
			...
			<div class="opdrachten">
				...
				<p>
					...
					waarmee je Java code kunt schrijven. In deze cursus gebruiken we <a
						href="http://www.eclipse.org/downloads/" target="_blank">Eclipse</a>.
					Kies
					<code>Eclipse IDE for java EE developers</code>
					. Let op dat als je een 64 bit jdk hebt ge&iuml;nstalleerd, je ook
			...
			<div class="opdrachten">
				...
				<p>
					Standaard staat
					<code>Use default location</code>
					aangevinkt. Dit zorgt er voor dat Eclipse het project opslaat in de
					huidige <em>workspace</em> map. Dit kun je eventueel veranderen als
...
<span class="codeplus">;</span>C:\Program Files (x86)\Git\cmd
				...
				<ol>
					...
					<li>open de terminal en ga met cd (change directory) naar de
						...
						https link naar je repo. Als je de repo opent vind je de link in
						het rechter zij-menu. (<code>https://github.com/</code>je
						gebruikersnaam<code>/inleiding-java.git</code>)
					</li>
					<li>voer in je terminal het volgend commando uit:<br> <pre
							class="code">
git clone https://github.com/[je gebruikersnaam]/inleiding-java.git
</pre> De repo wordt naar je computer gekopieerd en is automatisch gelinkt met
						je online (remote) repository op GitHub.
					</li>
					<li>in Eclipse kun je het project nu importeren met <code>File</code>
						&#8594; <code>Import...</code> &#8594; <code>Existing
							project into workspace</code>. Browse naar de map waar het project zich
					...
					<li>Open de src map in de explorer. Hierin zie je een <em>package</em>.
						...
						een java klasse. Open deze en klik op het groene pijltje in de
						menu balk om het programma uit te voeren. Als het goed is zie je
						in de Eclipse <em>console</em> de uitvoer:<br> <pre
							class="code">
Hallo roc-dev!
</pre>
					</li>
					<li>De uitvoer wordt gemaakt met de regel:<br> <pre
							class="code">
System.out.println(&quot;Hallo roc-dev!&quot;);
</pre>
					</li>
					<li>wijzig nu de tekst van de uitvoer en test of het werkt.
						Sla de wijzigingen op (ctrl/cmd + s). In de Eclipse explorer
						(links) zie je nu als het goed is een &gt; teken voor de
						projectnaam verschijnen. Dit betekent dat er wijzigingen zijn die
						nog niet in git zijn verwerkt. Om de wijzigingen in git op te
						slaan moet je ze <em>committen</em>. Klik met je rechtse muisknop
						op je project en kies <code>Team</code> &#8594; <code>Commit...</code>
						...
						Nadat je je wijzigingen hebt doorgevoerd is je <em>lokale</em>
						repo up to date.
					</li>
					<li>de volgende stap is om je repo te synchroniseren met je
						online repo op GitHub. Ga opnieuw naar <code>Team</code> en kies
						nu <code>Push to upstream</code>. Als het goed is worden je
					...
					<li>je kunt ook op GitHub zelf online wijzigingen in je code
						...
						ga je in Eclipse weer naar Team, kies <code>Fetch from
							upstream</code>. Dit haalt de evt wijzigingen die aangebracht zijn in je
						online repo op. Om de wijzigingen in je lokale git repo op te
						nemen ga je nogmaals naar <code>Team</code> en kies je voor <code>Pull</code>.
					</li>
