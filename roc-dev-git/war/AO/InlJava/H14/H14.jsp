...
<div class="col-md-9">
	...
	<p>Met de random-functie kunnen we willekeurige getallen genereren,
		dat betekent dat telkens als de functie aangeroepen wordt er een
		willekeurig getal van 0.0 tot 1.0 wordt aangemaakt. Let op: De 1.0
		komt dus nooit voor.</p>
	<pre class="code">
...
public class Random extends Applet {
	...
	<p>
		...
		Vandaar de punt tussen <b>Math</b> en <b>random()</b>. Door de regel <b>r
			= Math.random();</b> wordt een getal gegenereerd en dat getal wordt in de
		variable <b>r</b> gezet. Omdat het gaat om een getal vanaf 0.0 tot 1.0
		is r als <b>double</b> gedeclareerd.
	</p>
	<p>Veel stelt dit programma niet voor. Maar met deze functie kunnen
		we bijvoorbeeld het werpen van een dobbelsteen simuleren. Een
...
public class Random extends Applet {
	...
	<p>In Java kun je afbeeldingen van schijf opvragen en deze in het
		...
		worden getoond. Is de afbeelding niet in &eacute;&eacute;n van de drie
		formaten opgeslagen, dan kun je heel eenvoudig de afbeelding met een
		tekenprogramma zoals Paint of Paintshop converteren naar het juiste
		formaat.</p>
...
public class Afbeelding extends Applet {
	...
	<p>
		...
		afbeelding in het venster geplaatst. De werking van deze methode lijkt
		op die van het tekenen van rechthoeken. De eerste twee parameters
		geven de linkerbovenhoek van de afbeelding aan en de volgende twee de
		breedte en de hoogte van de afbeelding. Omdat drawImage() in de klasse
		Applet is ge&iuml;mplementeerd, kan de laatste parameter met <b>this</b>
		naar de applet verwijzen.
	</p>

	<h3>Geluid</h3>
	<p>Ook geluid is in Java niet moeilijk te realiseren. Het lijkt
		heel veel op de wijze waarop afbeeldingen ingelezen en getoond worden.
		Zie het volgende voorbeeld:</p>
	<pre class="code">
...
public class LoadAndPlay extends Applet {
	...
	<div class="opdrachten">
		...
		<h2>Opdracht 14.1</h2>
		<p>
			Schrijf een applet waarin het delen van &eacute;&eacute;n kaart wordt
			gesimuleerd. Er wordt willekeurig een kleur en binnen die kleur een
			willekeurige kaart gekozen. Maak een tabel voor de kleuren en
			&eacute;&eacute;n voor de kaarten binnen de kleuren. Laat de keuze
			als volgt in het venster van de applet zien, bijvoorbeeld: <em>Ruiten,
				aas</em>.
		</p>
		<h2>Opdracht 14.2</h2>
		...
		<p>Maak een spel waarbij een menselijke speler het tegen de
			...
			laatste steen wegneemt, verliest. Er mogen in &eacute;&eacute;n beurt
			1, 2 of 3 stenen weggenomen worden en er moet altijd
			&eacute;&eacute;n of meerdere stenen weggenomen worden.</p>
		<p>De computer vraagt eerst om menselijke invoer. De invoer wordt
			gecontroleerd (1, 2 of 3) en daarna vermindert de computer het aantal
			stenen. Vervolgens bepaalt de computer zijn eigen zet, deelt die aan
			de speler mee, vermindert het aantal stenen met zijn zet en vermeldt
			het aantal stenen. Dan is de speler weer aan de beurt enzovoorts
			totdat het aantal stenen nul is. Degene die de laatste steen heeft
			weggehaald, heeft verloren.</p>
		<p>
			...
			bij de voorlaatste zet 5 moet overhouden. De speler kan er dan altijd
			1, 2 of 3 wegnemen, daarna kan de computer ervoor zorgen dat er nog
			&eacute;&eacute;n steen overblijft. Die moet de speler dan nemen,
			waardoor de computer wint. De speler mag dus nooit 5 stenen kunnen
			overlaten, maar minstens 6. Dat kan als er nog 9 stenen overblijven.
			Als we zo doorredeneren, komen we tot de volgende getallen: 1, 5, 9,
			13, 17, 21. Op de eerste na is dat dus een <em>veelvoud van 4 +
				1</em>.
		</p>
