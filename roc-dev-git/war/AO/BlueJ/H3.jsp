	        ...
	        <div class="bs-callout bs-callout-warning">
		       <h2>Leerdoelen</h2>
				...
				<ul>
					...
					<p>In dit hoofdstuk ga je aan de slag met de <i>klassen</i> Bankrekening en Leerling. De broncode van de klassen vind je in het 
					werkboek. Klassen hebben i.h.a. attributen en methoden. Door middel van zogenaamde getters en setters kun je de waarde van attributen 
					respectievelijk opvragen en be&iuml;nvloeden.  </p>
					<h3>Klassendiagram</h3>
					<p>Een klassendiagram gebaseerd op de <a href="http://nl.wikipedia.org/wiki/Unified_Modeling_Language">Unified Modeling Language (UML)</a> bestaat uit
					een kop met de naam van de klasse, een onderdeel met de attributen en een onderdeel met de methoden. De naam van de klasse begint altijd met een 
					hoofdletter. Attributen beginnen met een kleine letter en de methoden - <span class="letop">afgezien van de constructor</span> - beginnen ook met een kleine letter.</p>
					...
					<div class="opdrachten" id="opdracht">
						<h2>Opdracht</h2>
						<p>In de laatste opdracht van hoofdstuk 4 heb je een applicatie gemaakt volgens onderstaand 
						schema.</p>
						<img src="images/wedstrijddiagram.png" width=600>
						<p>Maak dezelfde opdracht maar nu met Eclipse. Maak de volgende klassen:</p>
						<ul>
						...
						<h3>Aanwijzingen</h3>
						<p>Als je in Eclipse een klasse maakt en deze een aantal attributen geeft, kun je 
						vervolgens automatisch de constructor en de <em>&quot;getters&quot;</em> en de 
						<em>&quot;setters&quot;</em> aanmaken. Dit kan je enorm veel typewerk besparen. </p>
						<img src="images/eclipse.jpg" width=500>
						
						<h3>Constructor</h3>
						<p>Een constructor maakt een object van een klasse. Bij het aanmaken van het object 
						moeten de attributen een waarde krijgen. Dit doe je met behulp van <em>parameters</em>.</p>
<pre class="code">
public class Speler {
    String naam;
    Datum geboortedatum;
    ...
    ...
						...
						<p>Met het keyword <em>this</em> geef je aan dat het om een attribuut van de eigen 
						klasse gaat.</p>
						<p>Als je van een klasse een object maakt roep je de constructor aan met het keyword 
						<em>new</em>. De benodigde parameters die je in de constructor hebt gedefinieerd kun je op 
						verschillende manieren meegeven.</p>
<pre class="code">
<span class="codeplus">Datum datum = <span class="jsp">new</span> Datum(12, 1, 1987)</span>;
Speler speler1 = <span class="jsp">new</span> Speler(&quot;Pietje&quot;, <span class="codeplus">datum</span>);						
</pre>						
						<p>In bovenstaande code wordt eerst een datum-object gemaakt dat vervolgens wordt meegegeven 
						als parameter bij het maken van het speler-object. Het volgende codefragment laat zien dat dit 
						ook in &eacute;&eacute;n keer kan.</p>
<pre class="code">
Speler speler1 = <span class="jsp">new</span> Speler(&quot;Pietje&quot;, <span class="codeplus"><span class="jsp">new</span> Datum(12, 1, 1987)</span>);						
</pre>						
						<p>Als je een object maar &eacute;&eacute;n keer nodig hebt, is de tweede methode wel 
						zo effici&euml;nt.</p>
...
public <span class="codeplus">Speler</span> getSpeler1() {
    <span class="codeplus">return speler1</span>;
						...
						(bijvoorbeeld een int), een string of een object (bijvoorbeeld van type Speler). 
						Je kunt met getters bijvoorbeeld de naam van de spelers van een team opvragen.</p>
<pre class="code">
...
String naamSpeler2VanTeam1 = <span class="codeplus">team1.getSpeler2().getNaam()</span>;
						...
						<h3>Setters</h3>
						<p>Met een setter kun je een attribuut een waarde geven of de waarde ervan veranderen. 
						De klasse wedstrijd bijvoorbeeld heeft de volgende setter.</p>
<pre class="code">
public <span class="codeplus">void setUitslag(String uitslag)</span> {
    this.uitslag = uitslag;
}
</pre>						
						<p>Setters hebben geen terugkeerwaarde (void) en &eacute;&eacute;n parameter die 
						de waarde bevat die het attribuut moet krijgen.</p>
...
wedstrijd.<span class="codeplus">setUitslag(&quot;5-3&quot;)</span>;
						...
						<p>Iedere klasse stamt af van de klasse 
						<a href="http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html" 
						target="_blank">&quot;Object&quot;</a> en erft o.m. al haar methoden. E&eacute;n van 
						de methoden is toString() die een string representatie van een object geeft. Om een 
						string van een datum te maken zou je de volgende code kunnen gebruiken:</p>
<pre class="code">
Datum datum = new Datum(1, 1, 2015);
String datumString = &quot;&quot; + datum.getDag() + &quot;-&quot; + datum.getMaand(); + &quot;-&quot; + datum.getJaar();
</pre>						
						<p>Om te vermijden dat je bovenstaande code keer op keer moet aanmaken, kun je ook in de 
						klasse Datum de methode toString() &quot;overriden&quot;</p>
...
public String toString() {
    return &quot;&quot; + dag + &quot;-&quot; +maand + &quot;-&quot; + jaar;
						...
						<p>Als je dit hebt gedaan kun je voortaan als volgt van een datum de gewenste string maken. 
						Je hoeft de methode niet aan te roepen omdat java dat vanzelf doet als ze van een object 
						een string moet maken.</p>
