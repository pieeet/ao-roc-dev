...
<div class="col-md-9">
	...
	<div class="bs-callout bs-callout-warning">
		...
		<p>In deze serie lessen leer je een spel maken met behulp van
			...
			leren.</p>
		<p>
			In <a href="/AO/Greenfoot/includes/images.zip">images.zip</a> vind je
			de afbeeldingen die je nodig hebt voor het spel en in <a
				href="/AO/Greenfoot/includes/sounds.zip">sounds.zip</a> de geluiden.
			Als je het spel alvast wilt spelen kun je een <a
				href="/AO/Greenfoot/includes/GarpsGame.jar">uitwerking</a>
			downloaden.
		</p>
	</div>
	...
	<div class="opdrachten">
		...
		<p>We gaan de wereld van Garp in orde maken. Garp en Gnomus worden
			automatisch op de wereld gezet die steeds gevaarlijker wordt. We
			plaatsen een aantal obstakels in zijn wereld. Verder gaan we
	...
	<div class="opdrachten">
		...
		<p>Garp en Gnomus leven nog langs elkaar heen. Ze gaan nog over de
			rotsen en Garp verzamelt nog steeds geen diamanten. We gaan nu eerst
			Garp diamanten laten verzamelen en daarna leren we Gnomus hoe hij
			Garp moet vermoorden. En verder zullen ze niet over de rotsen heen
			kunnen, maar moeten zij er omheen. En, o, ja ... De bommen gaan
	...
	<div class="opdrachten">
		...
		<ol>
			<li>Gnomus kan al in de verte zien waar Garp is en vervolgens op
				Garp afgaan om hem te doden. Dat kun je programmeren met behulp van
				de methodes int getX() en int getY() van het object Garp. Het object
				Garp moet dan wel bekend zijn aan Gnomus: getObjectsInRange(100,
				&quot;Garp.class&quot;);</li>
			<li>Je kunt het spel ook met zijn twee spelers spelen, waarbij
				...
				op dezelfde manier aangestuurd als Garp maar dan met bijvoorbeeld de
				toetsen: Z, X, C en S, aan de linkerkant van het toetsenbord. De
				pijltjestoetsen zitten namelijk aan de rechterkant van het
				toetsenbord. Als Gnomus een bom raakt, ontploft de bom en heeft Garp
				gewonnen.</li>
			<li>Je kunt het spel ook zo veranderen dat er twee Garps zijn
				...
				gewonnen. Het bijhouden van de scores moet dan ook aangepast worden.
		</ol>
	</div>
