...
public class SportServlet extends <span class="codeplus">HttpServlet</span> {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		<p>Om het jezelf gemakkelijk te maken hoef je maar
			...
			deze methode door te sturen. Je hoeft je dan geen zorgen meer te
			maken over wanneer get en post worden gebruikt.</p>
		<p>Om requests naar een servlet te sturen heeft de servlet een
			adres (url) nodig. Je kunt de url van een servlet &quot;mappen&quot;
			in het web-xml bestand dat zich in de map WEB-INF van je war
			directory bevindt.</p>
		<pre class="code">
&lt;servlet&gt;
...
public void wijzigLid(Lid lid) {
    <span class="codeplus">this.voegLidToe(lid);</span>
		...
		<p>Maak deze methodes aan in je SportIO klasse. Gebruik de
