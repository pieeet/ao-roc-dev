      ...
      <h2>Java klassen</h2>
        ...
        <div class="bs-callout bs-callout-warning">
        	...
        	<div class="opdrachten" id="opg14">
						<h2>Opdracht 14</h2>
						<p>Maak dezelfde pagina als in opdracht 12, maar maak nu gebruik van een klasse die de berekeningen 
						uitvoert in plaats van dat de berekeningen in JSP worden uitgevoerd. Maak naast JSP gebruik van HTML en CSS 
						bij het uitvoeren van deze opdracht. </p>
						
						<% Graden gr = new Graden(); 
						String celsValue = "";
						String fahrValue = "";
						String warning = "";
						
						if (request.getParameter("knop14") != null) {
					        try {
					            if (!request.getParameter("cels").equals("") && !request.getParameter("fahr").equals("")) {
					                warning = "Voer slechts &#233;&#233;n getal in!";
					            }
					            else if (request.getParameter("cels").equals("") && request.getParameter("fahr").equals("")){
					            	warning = "Voer een getal in";
					            }
					            else if (!request.getParameter("cels").equals("")) {
					            	int fahr = gr.naarFahr(request.getParameter("cels"));
					                fahrValue += fahr;
					            }
					            else if (!request.getParameter("fahr").equals("")) {
									int cels = gr.naarCels(request.getParameter("fahr"));
					                celsValue += cels;
					            }
					        }
				        
				        	catch(NumberFormatException e) {
				                warning = "Voer alleen een geheel getal in";
				         	}
				        }
						
						%>
						<h3>Fahrenheit en Celsius omrekenen</h3>
				        <form action="Opdrachten3.jsp#opg14" method="get">
				            <table id="graden">
				                <tr>
				                    <th>Celsius</th>
				                ...
				                <tr>
				                    ...
				                    <td><input type="submit" name="knop14" value="Omrekenen"></td>
				                </tr>
				                <% if (request.getParameter("knop14") != null) { %>
				                <tr>
			 	        ...
			 	        <div class="toonknopcontainer">
							<button class="toonknop" id="toon14" onclick="toon('uitw14')">Toon uitwerking</button>
						</div>    
						
						<div class="uitwerking" id="uitw14">
							<p>In NetBeans maak je in je projectstructuur een java klasse. Klassen bevinden zich in zogenaamde 
							&quot;packages&quot; in de map &quot;Source Packages&quot;.</p>
							<img src="/AO/JSP_Java_DB/images/NBklasse.jpg" alt="Java klasse in NetBeans project">
							<h3>De java klasse</h3>
							<p>We maken een java klasse met een constructor en twee methoden om van Celsius naar Fahrenheit en vice 
							versa te rekenen. We geven aan de methoden een String mee als parameter. Deze String moet naar een int 
							worden geconverteerd met de methode Integer.parseInt(). Zoals we hebben gezien werpt deze methode een 
							NumberFormatException op als de conversie niet lukt. Door achter de methode &quot;throws NumberFormatException&quot; 
							te zetten geven we aan dat deze exception moet worden opgegooid als de methodes worden aangeroepen met een onjuiste 
							parameter(geen int). Later in de jsp gebruiken we deze exception om een foutmelding te maken.</p>
...
public class Graden {
	...
	public int naarFahr(String sCels) throws NumberFormatException {
		...
		return uitkomst;
							...
							<h3>De JSP pagina</h3>
							<p>In de JSP pagina willen we de klasse die we net hebben gemaakt gebruiken om de berekening 
							uit te voeren. Hiertoe moeten we de klasse importeren.</p>
							
<pre class="code">
&lt;%@page import=&quot;graden.Graden&quot; %&gt;
</pre>
							<p>Nu kunnen we een instantie van Graden aanmaken en daarop de twee methoden aanroepen. Als parameters 
							geven we de String mee die de methode request.getParameter(String s) teruggeeft.</p>
...
&lt;form action=&quot;index.jsp&quot; method=&quot;get&quot;&gt;
  &lt;table id=&quot;graden&quot;&gt;
    ...
    &lt;/tr&gt;
    &lt;tr&gt;
      &lt;td&gt;&lt;input type=&quot;text&quot; name=&quot;cels&quot; value=&quot;<span class="codeplus">&lt;%=celsValue%&gt;</span>&quot;&gt;&lt;/td&gt;
      &lt;td&gt;&lt;input type=&quot;text&quot; name=&quot;fahr&quot; value=&quot;<span class="codeplus">&lt;%=fahrValue%&gt;</span>&quot;&gt;&lt;/td&gt;
      &lt;td&gt;&lt;input type=&quot;submit&quot; name=&quot;knop&quot; value=&quot;Omrekenen&quot;&gt;&lt;/td&gt;
    &lt;/tr&gt;
    
    &lt;% if (request.getParameter(&quot;knop&quot;) != null) { %&gt;
      &lt;tr&gt;
        &lt;td colspan=&quot;2&quot; class=&quot;fout&quot;&gt;<span class="codeplus">&lt;%= warning %&gt;</span>&lt;/td&gt;
      &lt;/tr&gt;
    &lt;% } %&gt;
  &lt;/table&gt;
...
&lt;/form&gt;
					...
					<div class="opdrachten" id="opg15">
						<h2>Opdracht 15</h2>
						<p>Maak dezelfde pagina met de rekenmachine als in opdracht 13, maar maak nu gebruik van 
						een klasse die de berekeningen uitvoert in plaats van dat de berekeningen in JSP worden 
						uitgevoerd. Maak naast JSP gebruik van HTML en CSS bij het uitvoeren van deze opdracht.</p>
						
						<%
						Rekenmachine rm = new Rekenmachine();
						String uitkomst15 = "";
						String opg15Boodschap = "";
						
						
						if (request.getParameter("functie") != null) {
							if (request.getParameter("arg1").equals("") || request.getParameter("arg2").equals("")) {
								opg15Boodschap = "Voer <em>twee</em> getallen in";
							}
							else {
								try {
									
									double opg15Getal1 = Double.parseDouble(request.getParameter("arg1"));
									double opg15Getal2 = Double.parseDouble(request.getParameter("arg2"));
									String functie = request.getParameter("functie");
									uitkomst15 += rm.bereken(opg15Getal1, opg15Getal2, functie);
									
								}
								catch(NumberFormatException e) {
									opg15Boodschap = "Je mag alleen (decimale) getallen invoeren";
								}
								finally {
								}
						...
						%>
						<form action="Opdrachten3.jsp#opg15" method="get">
							<table id="rekenmachine">
								...
								<tbody>
									...
									<tr id="invoer">
										<td colspan="2"><input type="text" name="arg1" value="<%= uitkomst15 %>">
										<td colspan="2"><input type="text" name="arg2" value="">
									</tr>
									...
									<tr>
										<td colspan="4" class="foutboodschap"><%= opg15Boodschap %></td>
				...
				<!--  		<div class="toonknopcontainer">
						...
						<div class="uitwerking" id="uitw15">
							<p>In onderstaande code zijn iets andere keuzes gemaakt dan in de vorige opgave. Zoek de verschillen!</p>
    ...
    &lt;form action=&quot;index.jsp&quot; method=&quot;get&quot;&gt;
      ...
      &lt;table id=&quot;rekenmachine&quot;&gt;
        ...
        &lt;tbody&gt;
          ...
          &lt;tr id=&quot;invoer&quot;&gt;
            &lt;td colspan=&quot;2&quot;&gt;
              &lt;input type=&quot;text&quot; name=&quot;arg1&quot; value=&quot;<span class="codeplus">&lt;%= uitkomst %&gt;</span>&quot;
            &lt;/td&gt;
            &lt;td colspan=&quot;2&quot;&gt;
          ...
          &lt;tr&gt;
            &lt;td colspan=&quot;4&quot; class=&quot;fout&quot;&gt;<span class="codeplus">&lt;%= foutboodschap %&gt;</span>&lt;/td&gt;
          &lt;/tr&gt;
...
&lt;/html&gt;
							...
							<p><span class="letop">Merk op</span> dat er bij het programmeren vaak meerdere oplossingen mogelijk 
							zijn. Iedere programmeur ontwikkelt in zekere zin zijn eigen stijl. Let er wel op dat je probeert zo &quot;zuinig&quot; 
							mogelijk te programmeren en je code overzichtelijk te houden. Sommige bedrijven hanteren strenge stijlregels om hun 
							code uniform te houden.</p>
        ...
        $(document).ready(function() {  
            ...
            $("#knop_merk_prijs").click(function() {
                ...
                $.get("/autoshop?merk=" + merk + "&minprijs=" + minprijs + "&maxprijs=" + maxprijs, function(responseText) { 
					...
					<div class="opdrachten" id="zelftoets">
						...
						kan selecteren op merk of minimum- en/of maximumprijs.</p>
				            ...
				            <input type="text" id="maxprijs"><br>
						...
						<div id="autoselectie">
				          ...
				          <%  for (Auto auto: lijst) { %>
				                <div class="autokader">
									...
									<p class="prijs">Prijs: &euro; <%= auto.getPrijsFormat() %></p>
								</div>
				            <% } %>
				            
						</div>
					<div class="toonknopcontainer">
							<button class="toonknop" id="toonzelftoets" onclick="toon('uitwzelftoets')">Toon uitwerking</button>
					</div>
					
					<div class="uitwerking" id="uitwzelftoets">
						<p>Om je op weg te helpen kun je gebruik maken van de twee onderstaande Java klassen.</p>
<pre class="code">
package jspcursus;
    ...
    public ArrayList&lt;String&gt; getMerken() {
        ...
        return merken;
				...
				<div class="opdrachten" id="zelftoetsstudenten">
					...
					<div class="studentkadercontainer">
						<h3>Criteria voor de Ninja-levels</h3>
						<p>De definitieve criteria zijn nog onderwerp van gesprek, er kunnen derhalve geen rechten aan deze pagina worden ontleend</p>
						
							<h4>Groene band:</h4>
							<ul>
							 	<li>Het onderdeel &quot;programmeren&quot; van de proeve van bekwaamheid jaar 1 is als voldoende beoordeeld</li>
							 </ul>
							<h4>Zwarte band:</h4>
							<ul>
								 
								 <li>de HTML van het selectieveld &quot;Merk&quot; wordt automatisch gevuld met unieke merken. Default is &quot;alle merken&quot;</li>
								 <li>bij de inputvelden &quot;prijs&quot; hoeft maar &eacute;&eacute;n van beide velden door gebruiker te worden ingevuld (twee mag uiteraard ook)</li>
								 <li>de auto&#039;s verschijnen netjes naast en onder elkaar, de pagina elementen schalen afhankelijk van de schermgrootte</li>
								 <li>de prijzen van de produkten zijn geformatteerd volgens de Nederlandse standaard (1.000.000,-)</li>
								 <li>de pagina heeft een overzichtelijke lay-out en een wervende vormgeving</li>
								 <li>de pagina staat online in een produktieomgeving (zoals Google App Engine)</li>
								 <li>de broncode van de web-app is &quot;Open Source&quot; en is te vinden op <a href="https://github.com/" target="_blank">GitHub</a>
								 inclusief een readme bestand met een Engelstalige gebruiksaanwijzing</li>
							 </ul>
							 <h4>Gouden band: </h4>
							 <ul>
								 <li>alle vereisten zwarte band</li>
								 <li>de inputvelden prijs zijn vervangen door een &quot;slider&quot; waarmee zowel minimum- als maximumprijs kan 
								 worden aangepast (<a href="http://demos.jquerymobile.com/1.3.0-rc.1/docs/demos/widgets/sliders/rangeslider.html" target="_blank">voorbeeld</a>)</li>
								  <li>er kunnen nu ook meerdere merken worden geselecteerd</li>
								  <li>er kan nu ook een combinatie van Merk(en) en prijzen worden geselecteerd</li>
								 <li>de pagina is gekoppeld aan een database en er is functionaliteit toegevoegd zodat de eigenaar van de website 
								 zijn voorraad op gemakkelijke wijze kan beheren. </li>
								 <li>De auto-divs worden met <a href="http://api.jquery.com/jquery.ajax/">JQuery / AJAX</a>  ververst zonder dat 
								 de pagina hoeft te worden herladen</li>
						...
						for (Student st: sLijst) {
							if (st.getWebpage() == null) { %>
								<a href="pvb_jaar1_2014/<%= st.getHeleNaam().replace(" ", "") %>/index.jsp" target="_blank">
