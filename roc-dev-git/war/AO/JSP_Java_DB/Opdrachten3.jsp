					...
					<div class="opdrachten" id="opg15">
				        ...
				        $(document).ready(function() {  
				        	$(document).on('click', '#reken_functie_plus', function() {
				                ...
				                $.get("/rekenmachine?arg1=" + arg1 + "&arg2=" + arg2 + "&functie=" + functie, function(responseText) { 
				...
				<div class="opdrachten" id="zelftoetsstudenten">
					...
					<!-- <div id="ninjalevels">
						...
						<div class="ninja_level_uitleg">
							<img class="ninja_img_uitleg" alt="greenbelt" src="/images/green_belt.png">
							<ul>
						...
						<div class="ninja_level_uitleg">
							<img class="ninja_img_uitleg" alt="blackbelt" src="/images/black_belt.png">
							<ul>
							 ...
							 <li>er kan een combinatie van Merk(en) en prijzen worden geselecteerd</li>
