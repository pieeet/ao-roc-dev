...
<!-- lokale varianten javascript -->
<!-- <script src="/scripts_ext/goog_jquery_min.js" type="text/javascript"></script>
<script src="/scripts_ext/bootstrap.js" type="text/javascript"></script> -->
       ...
       <!--  Navigatie -->
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/AO/android/H1/H1.jsp">Android<span class="sr-only">(current)</span></a></li>
