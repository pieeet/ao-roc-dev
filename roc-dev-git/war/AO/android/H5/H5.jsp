      ...
      <div class="col-md-9">
        ...
        <div class="bs-callout bs-callout-warning">
			...
			<ul>
				...
				<li>menu items als <em>action-items</em> in je menubalk kunt tonen of kunt verbergen in het <em>options-menu</em></li>
				<li>weet hoe je het menu aanmaakt in een java activity met de methode <em>onCreateOptionsMenu</em> </li>
				<li>weet hoe je acties aam een menu item koppelt met de methode <em>onOptionsItemSelected</em></li>
				<li>weet hoe je een <em>Toast</em> maakt</li>
				<li>weet hoe je een nieuwe activity start</li>
				<li>een <em>Dialog</em> activity kunt maken en starten</li>
				<li>weet hoe je een instellingen scherm kunt maken met de klasse <em>Preference</em></li>
				<li>weet hoe je een <em>CheckBoxPreference</em> en een <em>ListPreference</em> aan het instellingenscherm toevoegt</li>
				<li>weet hoe je je instellingen in categorie&euml;n kunt groeperen</li>
				<li>weet hoe je een item in je instellingen kunt in- en uitschakelen</li>
        ...
        <div class="bs-callout bs-callout-info">
	        ...
	        <p>Uitgangspunt bij dit hoofdstuk is dat je Android API 11 of hoger als minimum sdk hanteert. Oudere 
	        versies gebruiken andere methodes die hier niet worden behandeld.</p>
	        <p>Maak van je fooi calculator java klasse een subklasse van ActionBarActivity</p>
<pre class="code">
public class FooiCalculatorActivity <span class="codeplus">extends ActionBarActivity</span>
</pre>
	        <p>Als het goed is importeert studio zelf de hiervoor benodigde klasse</p>
<pre class="code">
import android.support.v7.app.ActionBarActivity;
</pre>
	        <p>Je moet nu in je styles.xml een Theme.AppCompat thema gebruiken, bijvoorbeeld:</p>
<pre class="code">
...
&lt;/style&gt;
        ...
        <!-- inhoud -->
        <p>We gaan in dit hoofdstuk een menu aan de fooi calculator toevoegen. Een menu bestaat uit menu-items die op verschillende 
        wijze kunnen worden weergegeven. Ons menu bestaat uit twee items: instellingen en info.</p>
        
        <div class="opdrachten">
        	<h2>Opdracht 5.1</h2>
        	<h3>strings in je action bar</h3>
        	<p>Maak in je fooi calculator een menu met twee items: instellingen en info.<br> 
        	Voeg in je strings.xml twee nieuwe strings voor de menu-items toe.</p>
...
&lt;string name=&quot;menu_info&quot;&gt;Info&lt;/string&gt;
        	...
        	<p>Als het goed is heeft studio een map res/menu aangemaakt met daarin een xml bestand. Open dit bestand en 
        	zorg dat de inhoud er als onderstaand uit ziet. Wijzig de verwijzing naar de context (gemarkeerd) afhankelijk van 
        	de naam van je Activity klasse. </p>
        	
<pre class="code">
&lt;menu xmlns:android=&quot;http://schemas.android.com/apk/res/android&quot;
    xmlns:app=&quot;http://schemas.android.com/apk/res-auto&quot;
    xmlns:tools=&quot;http://schemas.android.com/tools&quot; tools:context=&quot;.<span class="codeplus">FooiCalculatorActivity</span>&quot;&gt;
    &lt;item
...
&lt;/menu&gt;
        ...
        <div class="opdrachten">
        	<h2>Opdracht 5.2</h2>
        	<h3>iconen</h3>
        	<p>Zorg dat de menu-strings uit de vorige opdrachten worden vervangen door iconen.</p>
        	<p>Gebruik onderstaande plaatjes of zoek in je Android SDK naar geschikte iconen in bijvoorbeeld de map<br> <b>\&lt;locatie sdk&gt;\sdk\platforms\android-19\data\res\drawable-xhdpi</b><br>
...
<pre class="code">
   ...
   /&gt;
		...
		<table>
			<tr><th>Naam</th><th>Beschrijving</th></tr>
			<tr><th>title</th><td>Specificeert de tekst van het item</td></tr>
			<tr><th>icon</th><td>Specificeert het icoon van het item</td></tr>
			<tr><th>showAsAction</th><td>Specificeert of een item in de Action Bar wordt vertoond</td></tr>
			<tr><th>orderInCategory</th><td>Bepaalt de volgorde waarin de items worden getoond, het laagste nummer wordt eerst getoond</td></tr>
		</table>
		<h3>Weergeven van het menu</h3>
		<p>In de java klasse van je activity wordt het menu aangemaakt met de volgende methode. Deze methode is al door studio voor je aangemaakt.</p>
<pre class="code">
@Override
public boolean onCreateOptionsMenu(Menu menu) {
    ...
    return true;
		...
		<div class="opdrachten">
			<h2>Opdracht 5.3</h2>	
			<p>Natuurlijk moet er iets gebeuren als de gebuiker &eacute;&eacute;n van de opties selecteert. De basis van deze methode 
			is ook al door studio voor je gemaakt met de methode <b>onOptionsItemSelected(MenuItem item)</b>. Met de volgende code kun je 
			een &quot;<a href="http://developer.android.com/reference/android/widget/Toast.html" target="_blank">Toast</a>&quot; maken. Dit is een 
			pop-up view met een korte boodschap die gedurende korte (LENGTH_SHORT: standaard 2 seconden) of lange tijd 
			(LENGTH_LONG: standaard 3,5 seconden) wordt vertoond.</p>
...
public boolean onOptionsItemSelected(MenuItem item) {
   ...
   switch (item.getItemId() ) {
       ...
       default:
    	...
    	<p>Als een app meerdere activities heeft worden menu&#39;s vaak gebruikt om tussen de schermen te navigeren.</p>
    	...
    	<div class="opdrachten">
    		...
    		<ol>
    			...
    			verwijzingen ernaar worden weggehaald:<br>
<pre class="code">
...
public class InfoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info); 
    			...
    			<li>Open in de map layout activity_info.xml. Je kunt de volgende code gebruiken:<br>
<pre class="code">
...
&lt;/RelativeLayout&gt;
			...
			<li>Maak in je styles.xml een nieuw thema dat een Dialog thema erft, bijvoorbeeld:<br>
			    			
<pre class="code">
&lt;style name=&quot;DialogTheme&quot; parent=&quot;Theme.AppCompat.Light.Dialog&quot; /&gt;
</pre>    			
    		</li>
    		<li>Open het AndroidManifest, je nieuwe activity is toegevoegd. Pas aan volgens onderstaand voorbeeld<br>
<pre class="code">
&lt;activity
    android:name=&quot;com.rocdev.InfoActivity&quot;<span class="comment">//afhankelijk van je project</span>
    android:label=&quot;@string/menu_info&quot;
    android:theme=&quot;@style/DialogTheme&quot;&gt;
&lt;/activity&gt;
</pre>    	</li>

			<li>Ga naar de FooiCalculatorActivity klasse en zorg dat je nieuwe Activity wordt gestart als gebruiker op het 
			info menu-item drukt. Je hebt hiervoor een <em>&quot;intent&quot;</em> nodig. Een 
			<a href="http://developer.android.com/reference/android/content/Intent.html" target="_blank">intent</a> is een object dat 
			een voorgenomen operatie beschrijft. In dit geval beschrijft de intent welke activity moeten worden gestart. Het intent 
			object kan vervolgens worden gebruikt als argument in de <em>startActivity</em> 
			methode.<br>
...
public boolean onOptionsItemSelected(MenuItem item) {
   ...
   switch (item.getItemId() ) {
       ...
       default:
    	...
    	<div class="opdrachten">
    		<h2>Opdracht 5.5</h2>
    		<p>Maak eenzelfde activity voor wanneer de gebruiker op &quot;Instellingen&quot; klikt.</p>
    	</div>
    	
    	<h3>Instellingen</h3>
    	<p>Voor de meeste activities gebruik je subklassen van de View klasse om je UI te bouwen. In deze cursus hebben we bijvoorbeeld 
    	voor het maken van de fooi calculator gebruik gemaakt van de TextView, EditText en Button klassen. 
    	Voor het maken van instellingen gebruik je subklassen van de klasse &quot;<a href="http://developer.android.com/reference/android/preference/Preference.html" target="_blank">Preference</a>&quot; 
    	om je scherm te maken. 
    	</p>
    	
    	<div class="opdrachten">
    		<h2>Opdracht 5.6</h2>
    		<p>Maak voor de fooi calculator een instellingen scherm waar gebruiker de volgende zaken kan instellen:</p>
    		<ul>
    		...
    		<ol>
    			...
    			preferences.xml. Open het bestand en voeg de volgende code toe. Uiteraard moet je ook de strings aanmaken.<br>
<pre class="code">
...
&lt;/PreferenceScreen&gt;
    		...
    		<h4>Uitleg</h4>
    		<p>Het root-element van het preference screen is het PreferenceScreen element. Binnen dit element kunnen zich &eacute;&eacute;n of 
    		meer preferences bevinden.</p>
    		<p>De CheckBoxPreference is het eerste item uit het voorbeeld. Preferences werken met een <em>key</em> attribuut om ze te identificeren 
    		(vergelijkbaar met id). Iedere preference heeft een  <em>key</em> - <em>value</em> combinatie die wordt opgeslagen in een SharedPreferences 
    		bestand (zie H2). Een CheckBoxPreference waarde is van het type boolean (true of false).</p>
    		<p>Het ListPreference element is het tweede item. Als gebruiker hierop drukt, verschijnt er een dialoog venster met een lijst met opties. 
    		Om deze lijst te maken moet je twee arrays in je strings.xml file maken. E&eacute;n voor de opties die in het scherm worden getoond 
    		en &eacute;&eacute;n voor de waardes van de opties. Als gebruiker een optie heeft gekozen, dan wordt de waarde van die optie samen met 
    		de key opgeslagen in het automatisch aangemaakte SharedPreferences bestand.</p></li>
    		<li>Maak de arrays in strings.xml<br>
...
&lt;/string-array&gt;
    			...
    			<li>Maak een &quot;Fragment&quot; klasse. Kijk <a href="http://developer.android.com/guide/topics/ui/settings.html#Fragment" target="_blank">hier</a> 
    			voor nadere uitleg. Fragments worden uitgebreid in het volgende hoofdstuk behandeld.<br>
<pre class="code">
public class InstellingenFragment extends <span class="codeplus">PreferenceFragment</span> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.preferences);
    		...
    		<li>Maak een settings Activity klasse die het zojuist gemaakte Fragment gebruikt.<br>
<pre class="code">
public class InstellingenActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction()
    		...
    		<li>Nu moet je de preferences in je fooicalculator java klasse laden. In hoofdstuk 2 heb je al een SharedPreferences object gebruikt om waardes 
    		op te slaan. Ditzelfde object kunnen we hier gebruiken, alleen moet hij op een iets andere manier ge&iuml;nstantieerd worden, zodat ook 
    		de waardes uit de instellingen gebruikt kunnen worden. Ook  hebben 
    		we een nieuw attribuut nodig van het type  boolean om te bepalen  of het fooipercentage bewaard moet worden of niet.<br>
<pre class="code">
...
<span class="codeplus">prefs = PreferenceManager.getDefaultSharedPreferences(this)</span>;
			...
			<li>Gebruik de &quot;bewaar percentage&quot; preference en de afronding preferences in de onResume methode<br>
<pre class="code">
@Override
public void onResume() {
    ...
    berekenEnToon();
    		...
    		<li>Tot slot moet de instellingen-activity gestart worden als gebruiker instellingen selecteert:<br>
<pre class="code">
public boolean onOptionsItemSelected(MenuItem item) {
    <span class="comment">// bepaal welk menu-item is geselecteerd</span>
   switch (item.getItemId() ) {
       ...
       default:
           return super.onOptionsItemSelected(item);
    		...
    		...en moet de juiste afronding RadioButton gechecked worden in de methode berekenEnToon.<br>
<pre class="code">
...
if (afronding == AFROND_GEEN) {
    <span class="codeplus">afrondGeenRadioButton.setChecked(true);</span>
    	...
    	<p>Je weet nu hoe je met instellingen kunt werken. We gaan deze vaardigheden uitbreiden voor het geval je apps gaat 
    	maken die meer instellingen hebben of waarvoor wat ingewikkelder vereisten gelden.</p>
    	<h4>Instellingen groeperen</h4>
    	<p>Als je veel instellingen hebt is het overzichtelijker om ze te groeperen in categorie&euml;n:</p>
...
&lt;/PreferenceCategory&gt;
    		...
    		<li>Verander je java code. Als gebruiker er  voor gekozen heeft om het fooipercentage <em>niet</em> te onthouden, moet 
    		het gekozen default fooipercentage worden gebruikt (in de methode <em>onResume</em>).</li>  
    	</ol>
    	...
    	<div class="opdrachten">
	    	<h2>Opdracht 5.8</h2>
	    	<p>Verander de code van het preferences bestand zodat de gebruiker aan kan vinken dat het fooipercentage moet worden vergeten in 
	    	plaats van onthouden. Dit heeft enige gevolgen voor je java code! Zorg ervoor dat de standaard fooi lijst alleen geselecteerd kan worden 
	    	als de bovenliggende checkbox is aangevinkt volgens bovenstaande afbeelding.</p>
<pre class="code">
&lt;CheckBoxPreference
